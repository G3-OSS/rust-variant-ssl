...
#define BINDGEN_SYMBOL_PREFIX2(X) RUST_BINDGEN_SYMBOL_PREFIX_##X##_
#define BINDGEN_SYMBOL_PREFIX(X) BINDGEN_SYMBOL_PREFIX2(X)
#if defined(OPENSSL_IS_AWSLC) && defined(BORINGSSL_PREFIX)
BINDGEN_SYMBOL_PREFIX(BORINGSSL_PREFIX)
#endif
